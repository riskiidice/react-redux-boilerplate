      ...
      <div>
        <header className="main-header">
            <a href="index2.html" className="logo">
              <span className="logo-mini"><b>C</b>ND</span>
              <span className="logo-lg"><b>CND</b>Docs</span>
            </a>
              ...
              <div className="navbar-custom-menu">
                <ul className="nav navbar-nav">
                        ...
                        <ul className="menu">
                          ...
                          <li>
                            <a href="#">
                              ...
                              <div className="progress xs">
                                <div className="progress-bar progress-bar-green" style={{ width:'20%' }} role="progressbar"
                                    aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                  ...
                  <li className="dropdown user user-menu">
                    <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                      <img src="https://www.gravatar.com/avatar/a626aece6da9e7faaf7b36de12133347" className="user-image" alt="User Image" />
                      <span className="hidden-xs">{ auth.user.name ? auth.user.name : "" }</span>
                    </a>
                    <ul className="dropdown-menu">
                      ...
                      <li className="user-header">
                        ...
                        <p>
                        { auth.user.name ? auth.user.name : "" } - Web Developer
                          <small>Member since Nov. 2012</small>
                        </p>
                      </li>
                      <li className="user-footer">
                          <a onClick={this.onLogoutUser.bind(this)} className="btn btn-default btn-flat btn-block">Sign out</a>
                      </li>
                    </ul>
                  </li>
